...
class AboutMessagePassing < Neo::Koan
  ...
  def test_sending_a_message_with_arguments
    ...
    assert_equal [], mc.add_a_payload #DUDA
  ...
  def test_all_messages_are_caught
    ...
    assert_equal "Someone called foobar with <>", catcher.foobar #DUDA
  ...
  class WellBehavedFooCatcher
    def method_missing(method_name, *args, &block) # Ya esta definido por defecto en los objetos??
