...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # in .inject(VALUE), VALUE is default value for accumulator variable (sum,product)
    # the .inject uses the accumulator and the next item in the array. Always storing
